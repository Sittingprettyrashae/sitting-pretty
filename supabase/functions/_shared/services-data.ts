// GENERATED MIRROR of /services-data.js (do not hand-edit prices here).
// Regenerate whenever services-data.js changes so client and server agree.
// Source of truth: Ke'Ebonie Hill's StyleSeat catalog, see /styleseat-reference.md.

export type RawServiceRow = [name: string, price: string, duration: string, note: string];

export const RAW_SERVICES: Array<{ cat: string; items: RawServiceRow[] }> = [
  { cat: "Sew-ins", items: [
